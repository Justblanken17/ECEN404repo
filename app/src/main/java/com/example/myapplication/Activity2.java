...
public class Activity2 extends AppCompatActivity {
        ...
        protected String doInBackground(String... params) {
            ...
            runOnUiThread(new Runnable() { //runONUi thread allows content to run on main thread since, only there can necessary code be run
                ...
                public void run() {
                    ...
                    Button buttonreferesh = (Button) findViewById(R.id.buttonrefresh2);
                    Button buttonback = (Button) findViewById(R.id.buttonback2);
                    Button buttonexpec = (Button) findViewById(R.id.buttonback3);
    ...
    public void openexpecbutton(){
        Intent intent = new Intent(this, activity2expected.class); //causes the subordinate activity file to be opened, redirects to new layout
        startActivity(intent);
    }
