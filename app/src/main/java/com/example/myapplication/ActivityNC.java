...
public class ActivityNC extends AppCompatActivity {
    ...
    class Connector extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = "http://10.231.226.125/android_connect/nc.php"; //10.216.2.136  10.236.39.36 10.236.46.44 holds the link for the php file I want to connect to
            try{
            ...
            runOnUiThread(new Runnable() { //runONUi thread allows content to run on main thread since, only there can necessary code be run
                ...
                public void run() {
                    ...
                    Button buttonreferesh = (Button) findViewById(R.id.buttonrefreshnc);
                    Button buttonback = (Button) findViewById(R.id.buttonbacknc);
                    Button buttonbackncexcep = (Button) findViewById(R.id.buttonback10);
                    ...
                    buttonbackncexcep .setOnClickListener(new View.OnClickListener() { //this section will allow the button to perform the method call when the button is pressed
                        @Override
                        public void onClick(View view) {
                            openActivityncextend();
                        }
                    });
    ...
    public void openActivityncextend(){
        Intent intent = new Intent(this, activityncexpected.class); //causes the subordinate activity file to be opened, redirects to new layout
        startActivity(intent);
    }
