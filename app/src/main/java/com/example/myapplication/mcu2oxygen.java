...
public class mcu2oxygen extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu2oxygen);
        TextView oxyg1 = findViewById(R.id.oxy9);
        TextView oxyg2 = findViewById(R.id.oxy5);
        TextView oxyg3 = findViewById(R.id.oxy6);
        TextView oxyg4 = findViewById(R.id.oxy7);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu2);
        Button buttonback = (Button) findViewById(R.id.backmcu2);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Oxygen").child("Sensor 1");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Oxygen").child("Sensor 2");
        DatabaseReference rootDatabaseref3 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Oxygen").child("Sensor 3");
        DatabaseReference rootDatabaseref4 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Oxygen").child("Sensor 4");
