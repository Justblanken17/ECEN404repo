...
public class mcu4temphumid extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu4temphumid);
        TextView temp1 = findViewById(R.id.temp10);
        TextView temp2 = findViewById(R.id.temp11);
        TextView temp3 = findViewById(R.id.temp12);
        // ethy4 = findViewById(R.id.ethy4);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu1temp4);
        Button buttonback = (Button) findViewById(R.id.backmcu1temp4);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 4").child("Temperature and Humidity").child("Sensor 1");//.child("TH").child("Sensor 1");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 4").child("Temperature and Humidity").child("Sensor 2");
        DatabaseReference rootDatabaseref3 = FirebaseDatabase.getInstance().getReference().child("MCU 4").child("Temperature and Humidity").child("Sensor 3");
