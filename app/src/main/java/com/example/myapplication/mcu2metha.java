...
public class mcu2metha extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu2metha);
        TextView methy1 = findViewById(R.id.methane12);
        TextView methy2 = findViewById(R.id.methane13);
        TextView methy3 = findViewById(R.id.methane10);
        TextView methy4 = findViewById(R.id.methane11);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu1methane3);
        Button buttonback = (Button) findViewById(R.id.backmcu1methane3);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Methane").child("Sensor 1");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Methane").child("Sensor 2");
        DatabaseReference rootDatabaseref3 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Methane").child("Sensor 3");
        DatabaseReference rootDatabaseref4 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Methane").child("Sensor 4");
