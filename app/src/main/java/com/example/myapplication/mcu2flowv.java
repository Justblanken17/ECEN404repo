...
public class mcu2flowv extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu2flowv);
        TextView flowv1 = findViewById(R.id.flowv);
        TextView flowv2 = findViewById(R.id.flowv2);
        //TextView flowv3 = findViewById(R.id.flowv3);
        //TextView flowv4 = findViewById(R.id.flowv4);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu1maxflu2);
        Button buttonback = (Button) findViewById(R.id.backmcu1maxfl2);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Water Flow").child("Water Flow 1");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 2").child("Water Level").child("Sensor 1");
