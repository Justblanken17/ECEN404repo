...
public class Camera3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image1 = (ImageView)findViewById(R.id.imageView107);
        ...
        lStorage2 = FirebaseStorage.getInstance().getReference().child("MCU 1/Camera 3");
        filepathhappen2 = "";
        ...
        lStorage2.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                filepath2 = "MCU 1/Camera 3/"+ filepathhappen2;
    ...
    */
      public void stuff(){
          String urlstuff = "MCU 1/Camera 3/Images";
