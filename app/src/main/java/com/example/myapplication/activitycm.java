...
public class activitycm extends AppCompatActivity {
    ...
    class Connector extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = "http://10.231.226.125/android_connect/cm.php"; //10.216.2.136  10.236.39.36 10.236.46.44 holds the link for the php file I want to connect to
            try{
            ...
            runOnUiThread(new Runnable() { //runONUi thread allows content to run on main thread since, only there can necessary code be run
                ...
                public void run() {
                    ...
                    Button buttonreferesh = (Button) findViewById(R.id.buttonrefreshcm);
                    Button buttonback = (Button) findViewById(R.id.buttonbackcm);
                    Button buttonexpec = (Button) findViewById(R.id.buttonback4);
    ...
    public void openActivitycmexpec(){
        Intent intent = new Intent(this, activitycmEXPECTED.class); //causes the subordinate activity file to be opened, redirects to new layout
        startActivity(intent);
    }
