...
public class mcu3temp extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu3temp);
        TextView temp1 = findViewById(R.id.temp7);
        TextView temp2 = findViewById(R.id.temp8);
        TextView temp3 = findViewById(R.id.temp9);
        // ethy4 = findViewById(R.id.ethy4);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu1temp3);
        Button buttonback = (Button) findViewById(R.id.backmcu1temp3);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 3").child("Temperature and Humidity").child("Sensor 1");//.child("TH").child("Sensor 1");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 3").child("Temperature and Humidity").child("Sensor 2");
        DatabaseReference rootDatabaseref3 = FirebaseDatabase.getInstance().getReference().child("MCU 3").child("Temperature and Humidity").child("Sensor 3");
