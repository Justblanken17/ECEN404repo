...
public class mcu1methanegraphminutes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu1methanegraphminutes);
        ...
        DatabaseReference rootDatabaserefmin = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Methane").child("Sensor 1");
        DatabaseReference rootDatabaserefmin2 = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Methane").child("Sensor 2");
        DatabaseReference rootDatabaserefmin3 = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Methane").child("Sensor 3");
        DatabaseReference rootDatabaserefmin4 = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Methane").child("Sensor 4");
        ...
        rootDatabaserefmin.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //cra.setText(ge);
                graph.setTitle("         Methane Sensor 1");
        ...
        rootDatabaserefmin2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //ge = String.valueOf(series.findDataPointAtX(1));
                //cra.setText(ge);
                graph.setTitle("         Methane Sensor 2");
                graph.setTitleTextSize(25);
                graph.removeAllSeries();
                graph.addSeries(series);
                LineGraphSeries lil = series;
        ...
        rootDatabaserefmin3.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                LineGraphSeries<DataPoint> series;
                String data;// = snapshot.child();
                ...
                c = concentration[0];
                //oxyg1.setText(String.valueOf(c));
                GraphView graph = (GraphView) findViewById(R.id.graph7);
                //GraphView graph2 = (GraphView) findViewById(R.id.graph);
                series = new LineGraphSeries<DataPoint>();
                double g = 0;
                String ge;
                ...
                //ge = String.valueOf(series.findDataPointAtX(1));
                //cra.setText(ge);
                graph.setTitle("         Methane Sensor 3");
                graph.setTitleTextSize(25);
                graph.removeAllSeries();
                graph.addSeries(series);
                GridLabelRenderer griLa = graph.getGridLabelRenderer();
        ...
        rootDatabaserefmin4.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                LineGraphSeries<DataPoint> series;
                String data;// = snapshot.child();
                ...
                c = concentration[0];
                //oxyg1.setText(String.valueOf(c));
                GraphView graph = (GraphView) findViewById(R.id.graph8);
                //GraphView graph2 = (GraphView) findViewById(R.id.graph);
                series = new LineGraphSeries<DataPoint>();
                double g = 0;
                String ge;
...
//////                                                                  minutes+3
                ...
                //ge = String.valueOf(series.findDataPointAtX(1));
                //cra.setText(ge);
                graph.setTitle("         Methane Sensor 4");
                graph.setTitleTextSize(25);
                graph.removeAllSeries();
                graph.addSeries(series);
                LineGraphSeries lil = series;
    ...
    public void openActivityrefresh(){
        Intent intent = new Intent(this, mcu1methanegraphminutes.class); //causes the subordinate activity file to be opened, redirects to new layout
