...
public class mcu1temphumidgraphminutes extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu1temphumidgraphminutes);
        ...
        DatabaseReference rootDatabaserefmin = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Temperature and Humidity").child("Sensor 1");
        DatabaseReference rootDatabaserefmin2 = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Temperature and Humidity").child("Sensor 2");
        DatabaseReference rootDatabaserefmin3 = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("Temperature and Humidity").child("Sensor 3");
        ...
        rootDatabaserefmin.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //cra.setText(ge);
                graph.setTitle("    Temp/Humid Sensor 1");
        ...
        rootDatabaserefmin2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //ge = String.valueOf(series.findDataPointAtX(1));
                //cra.setText(ge);
                graph.setTitle("    Temp/Humid Sensor 2");
                graph.setTitleTextSize(25);
                graph.removeAllSeries();
                graph.addSeries(series);
                LineGraphSeries lil = series;
        ...
        rootDatabaserefmin3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //ge = String.valueOf(series.findDataPointAtX(1));
                //cra.setText(ge);
                graph.setTitle("    Temp/Humid Sensor 3");
                graph.setTitleTextSize(25);
                graph.removeAllSeries();
                graph.addSeries(series);
                GridLabelRenderer griLa = graph.getGridLabelRenderer();
    ...
    public void openActivityrefresh(){
        Intent intent = new Intent(this, mcu1temphumidgraphminutes.class); //causes the subordinate activity file to be opened, redirects to new layout
