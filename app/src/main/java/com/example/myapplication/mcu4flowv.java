...
public class mcu4flowv extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mcu4flowv);
        TextView flowv1 = findViewById(R.id.flowv5);
        TextView flowv2 = findViewById(R.id.flowv6);
        //TextView flowv3 = findViewById(R.id.flowv3);
        //TextView flowv4 = findViewById(R.id.flowv4);
        Button buttonreferesh = (Button) findViewById(R.id.refreshmcu1maxflu4);
        Button buttonback = (Button) findViewById(R.id.backmcu1maxfl4);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 4").child("Water Flow").child("Water Flow");
        DatabaseReference rootDatabaseref2 = FirebaseDatabase.getInstance().getReference().child("MCU 4").child("Water Level").child("Sensor 1");
