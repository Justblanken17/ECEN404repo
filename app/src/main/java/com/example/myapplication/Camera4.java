...
public class Camera4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filepath = "MCU 1/Camera 4/";
        filepath2 = "";
        filepathappen = "";
        filepathhappen2 = "";
        Button buttongraph = (Button) findViewById(R.id.graphthing4);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU Test").child("Camera States").child("State 4");
        ...
        lStorage2 = FirebaseStorage.getInstance().getReference().child("MCU 1/Camera 4");
        filepathhappen2 = "";
        lStorage2.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                filepath2 = "MCU 1/Camera 4/"+ filepathhappen2;
    ...
    */
    ...
    public void stuff(){
        String urlstuff = "MCU 1/Camera 4/Images";
        urlstuff = urlstuff + String.valueOf(photonumber);
        Button buttonback = (Button) findViewById(R.id.buttonbsckimage2);
        TextView stateb = findViewById(R.id.statetext4);
        DatabaseReference rootDatabaseref = FirebaseDatabase.getInstance().getReference().child("MCU 1").child("State").child("Camera 4");
        lStorage2.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
    ...
    public void openActivitygraph(){
        Intent intent = new Intent(this, camera4graph.class); //causes the subordinate activity file to be opened, redirects to new layout
        startActivity(intent);
    }
