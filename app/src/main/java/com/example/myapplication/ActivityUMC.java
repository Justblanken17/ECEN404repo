...
public class ActivityUMC extends AppCompatActivity {
    ...
    class Connector extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = "http://10.231.226.125/android_connect/establishconnection.php"; //10.216.2.136  10.236.39.36 10.236.46.44 holds the link for the php file I want to connect to
            try{
            ...
            runOnUiThread(new Runnable() { //runONUi thread allows content to run on main thread since, only there can necessary code be run
                ...
                public void run() {
                    ...
                    Button buttonreferesh = (Button) findViewById(R.id.buttonrefreshumc);
                    Button buttonback = (Button) findViewById(R.id.buttonbackumc);
                    Button buttonexpec = (Button) findViewById(R.id.buttonback12);
    ...
    public void openActivityexpec(){
        Intent intent = new Intent(this, activityumcexpected.class); //causes the subordinate activity file to be opened, redirects to new layout
        startActivity(intent);
    }
