...
public class ActivityUMC extends AppCompatActivity {
    ...
    class Connector extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String link = "http://10.230.160.179/android_connect/establishconnection.php"; //10.216.2.136  10.236.39.36 10.236.46.44 holds the link for the php file I want to connect to
            try{
