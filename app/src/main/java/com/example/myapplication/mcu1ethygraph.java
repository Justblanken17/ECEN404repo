...
public class mcu1ethygraph extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcu1ethygraph);
    ...
    public void openActivityminutes(){
        ...
        if(indication == 0)
        {
            ...
            graph2.setTitle("         Ethylene Sensor 2");
            ...
            graph3.setTitle("         Ethylene Sensor 3");
            ...
            graph4.setTitle("         Ethylene Sensor 4");
